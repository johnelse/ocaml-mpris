(* OASIS_START *)
(* DO NOT EDIT (digest: 8ea7a5a6441615e8fc81d851db28698c) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml =
       [("mpris", ["lib"], []); ("mpris_clients", ["clients"], [])];
     lib_c = [];
     flags =
       [
          (["oasis_library_mpris_byte"; "ocaml"; "link"; "byte"],
            [(OASISExpr.EBool true, S [A "-bin-annot"])]);
          (["oasis_library_mpris_native"; "ocaml"; "link"; "native"],
            [(OASISExpr.EBool true, S [A "-bin-annot"])]);
          (["oasis_library_mpris_byte"; "ocaml"; "ocamldep"; "byte"],
            [(OASISExpr.EBool true, S [A "-bin-annot"])]);
          (["oasis_library_mpris_native"; "ocaml"; "ocamldep"; "native"],
            [(OASISExpr.EBool true, S [A "-bin-annot"])]);
          (["oasis_library_mpris_byte"; "ocaml"; "compile"; "byte"],
            [(OASISExpr.EBool true, S [A "-bin-annot"])]);
          (["oasis_library_mpris_native"; "ocaml"; "compile"; "native"],
            [(OASISExpr.EBool true, S [A "-bin-annot"])]);
          (["oasis_library_mpris_clients_byte"; "ocaml"; "link"; "byte"],
            [(OASISExpr.EBool true, S [A "-bin-annot"])]);
          (["oasis_library_mpris_clients_native"; "ocaml"; "link"; "native"],
            [(OASISExpr.EBool true, S [A "-bin-annot"])]);
          (["oasis_library_mpris_clients_byte"; "ocaml"; "ocamldep"; "byte"],
            [(OASISExpr.EBool true, S [A "-bin-annot"])]);
          ([
              "oasis_library_mpris_clients_native";
              "ocaml";
              "ocamldep";
              "native"
           ],
            [(OASISExpr.EBool true, S [A "-bin-annot"])]);
          (["oasis_library_mpris_clients_byte"; "ocaml"; "compile"; "byte"],
            [(OASISExpr.EBool true, S [A "-bin-annot"])]);
          ([
              "oasis_library_mpris_clients_native";
              "ocaml";
     ...
     includes = [("demo", ["clients"]); ("clients", ["lib"])]
  }
  ;;

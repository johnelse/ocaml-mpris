...
(* OASIS_START *)
(* DO NOT EDIT (digest: 0e15f0f675a4312d89035f5ad311a675) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis =
            "Client library for the MPRIS D-Bus media player interface";
          description = None;
          categories = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Mpris_client_generic"; "Mpris_interfaces"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "mpris";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "mpris_clients";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "mpris";
                      lib_findlib_name = Some "clients";
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                     cs_name = "demo_spotify";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "demo_spotify.ml"})
            ];
     ...
     oasis_version = "0.3.0";
     oasis_digest =
       Some "\158\212\226\150\240O\020:u\217\239\133\006\195\023\219";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
